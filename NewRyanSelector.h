...
double* CorrParticle(double, double, double, double);
...
TVector3 GetPosition(int detector,char pos, int horizontalstrip, int verticalstrip, double X=0., double Y=0., double Z=0.);
