...
// Mon Aug 13 15:25:52 2018 by ROOT version 5.34/36
// from TTree ryandata/More resonable data format
// found on file: ../EventOut.root
//////////////////////////////////////////////////////////

#ifndef AngSelector_h
#define AngSelector_h
...
class AngSelector : public TSelector {
public :
   ...
   AngSelector(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~AngSelector() { }
   ...
   ClassDef(AngSelector,0);
};

#endif

#ifdef AngSelector_cxx
void AngSelector::Init(TTree *tree)
{
